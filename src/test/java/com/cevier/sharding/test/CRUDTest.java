...
public class CRUDTest {
    ...
    @Test
    public void geParagraphByArticleId2() {
        var paragraphs = paragraphService.getByArticleId(2);
        paragraphs.forEach(System.out::println);
    }

    @Test
    public void geParagraphByArticleId3() {
        var paragraphs = paragraphService.getByArticleId(2);
        paragraphs.forEach(System.out::println);
    }

    @Test
    public void geParagraphByArticleId4() {
        var paragraphs = paragraphService.getByArticleId(2);
        paragraphs.forEach(System.out::println);
    }

    @Test
    public void geParagraphByArticleId5() {
        var paragraphs = paragraphService.getByArticleId(2);
        paragraphs.forEach(System.out::println);
    }

    @Test
    public void geParagraphByArticleId6() {
        var paragraphs = paragraphService.getByArticleId(2);
        paragraphs.forEach(System.out::println);
    }
